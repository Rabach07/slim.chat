...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-138691962-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-138691962-1');
    </script>
            ...
            <div class="container flex mx-auto">
                ...
                <div>
                    ...
                    <ul class="list-reset flex">
                        ...
                        <li class="p-2">
                            <a href="{{ route('pricing') }}" class="inline-block py-3 px-2 text-lg text-grey-darkest hover:underline no-underline">
                                Pricing
                            </a>
                        </li>
                        <li class="p-2">
